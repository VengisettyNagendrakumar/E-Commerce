...
def getProducts(request):
    ...
    products = Product.objects.filter(name__icontains=query) #name__icontains means if name has letters in query filter acc to name here in icontains i means case insensitiive
